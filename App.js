  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        >
            <Text style={styles.welcome}>Click here!</Text>
        </TouchableOpacity>
      </View>
    );
  }
